...
function Footer() {
  return (
    <footer style={{ background: '#090d16', color: '#94a3b8', padding: '64px 0 32px 0', borderTop: '1px solid #1e293b' }}>
      <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '48px', marginBottom: '48px' }}>
        ...
        {/* Quick Links */}
        <div>
          <h4 style={{ fontSize: '14px', fontWeight: '700', color: '#ffffff', marginBottom: '20px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
            Quick Links
          </h4>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '14px' }}>
            ...
            <li><Link to="/ai-assistant" style={{ color: '#fb923c', textDecoration: 'none', fontWeight: '600' }}>✨ AI Wall Visualizer</Link></li>
        ...
        <div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '14px' }}>
            ...
            <li><Link to="/vendor/login" style={{ color: '#cbd5e1', textDecoration: 'none' }}>Vendor Partner Portal</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p style={{ fontSize: '14px', lineHeight: '1.65', color: '#cbd5e1', margin: '0 0 12px 0' }}>
            Delhi NCR • Mumbai • Bengaluru • Hyderabad • Pune • Across 20+ Cities
          </p>
          <span style={{ fontSize: '13px', color: '#64748b', display: 'block' }}>
            Support: <a href="mailto:support@decorfesto.com" style={{ color: '#fb923c', textDecoration: 'none', fontWeight: '600' }}>support@decorfesto.com</a>
          </span>
        </div>
      </div>
      ...
      <div className="container" style={{ paddingTop: '32px', borderTop: '1px solid #1e293b', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '16px', fontSize: '13px', color: '#64748b' }}>
        <span>© {new Date().getFullYear()} DecorFesto. All rights reserved.</span>
        <span>Crafted for premium event experiences across India.</span>
      </div>
    </footer>
  );
}
